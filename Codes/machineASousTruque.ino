...
* Ce programme est un programme de triche sans l'aléatoire. Cela permet de gagner à tous les coups.
*/
...
void loop() {
  ...
  if (val == LOW){ // Si on appuie sur le bouton, les roues tournent
    ...
    // On force les roues à se rendre sur 3 symboles identiques (ici les trois "7")
    nbAleatoire1 = 39;
    nbAleatoire2 = 38;
    nbAleatoire3 = 39;
